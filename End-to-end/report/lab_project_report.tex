...
\begin{subfigure}[b]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/training_curve_1.png}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/training_curve_2.png}
\end{subfigure}
\caption{Synthetic pretraining diagnostics for the hybrid NN-GARCH model. The network recovers the geometry of GARCH-style heteroskedastic dynamics from simulated series, providing a financially meaningful initialization before real-data fine-tuning.}
\label{fig:synth-pretrain}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{test_on_real_time_series_cell24_0.png}
